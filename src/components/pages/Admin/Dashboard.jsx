...
//             <p>Here you can add, edit or remove doctors.</p> */}
...
//             </h1>
//             <AdminAmbulanceRequests></AdminAmbulanceRequests>
//           </div>
//         );
...
//       {/* Sidebar */}
//       <div className="w-64 bg-[rgb(7,143,247)] text-white p-6 space-y-4">
...
//       {/* Main Content */}
//       <div className="flex-1 bg-gray-100 p-8">{renderContent()}</div>
//     </div>
//   );
// };
...
//             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
//               {/* Total Doctors */}
//               <div className="bg-white shadow-md hover:shadow-lg transition rounded-2xl p-6 flex items-center space-x-4">
...
//             onClick={() => setActiveMenu("doctors")}
//             className={`flex items-center space-x-3 p-2 rounded hover:bg-blue-500 w-full ${
//               activeMenu === "doctors" ? "bg-blue-500" : ""
//             }`}
//           >
//             <FaUserMd />
//             <span>Doctors</span>
...
//             onClick={() => setActiveMenu("appointments")}
//             className={`flex items-center space-x-3 p-2 rounded hover:bg-blue-500 w-full ${
//               activeMenu === "appointments" ? "bg-blue-500" : ""
//             }`}
//           >
//             <FaClipboardList />
...
//             onClick={() => setActiveMenu("ambulances")}
//             className={`flex items-center space-x-3 p-2 rounded hover:bg-blue-500 w-full ${
//               activeMenu === "ambulances" ? "bg-blue-500" : ""
//             }`}
//           >
//             <FaAmbulance />
